		...
		else if(q===8||q===9||q===10)
		{
			if(wanted===false)
			{
			    ...
			    if(randomn===-1)
			    {
				    ...
				    gamemessage("You were stopped by the intergalatic police force for a random ship inspection "+result);
			    }
			    else if(randomn===-2)
			    {
			    ...
			    else
			    {
					situation=true;
					situationnumber=1;
				    result="The officer finds out about all that music you pirated online. You are arrested imediatly";
				    gamemessage("You were stopped by the intergalatic police force for a random ship inspection "+result+"</br></br>will you pay the bail of $10000 or take a chance and break out?</br></br>bail or escape");
