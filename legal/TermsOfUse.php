...
<div class="container">
    ...
    <style>.tab3 {font-weight:bold;}</style>
    <cms:editable name='Purpose' type='richtext'>
<p>These terms of service apply to the Math I/O website and all associated sites linked to Math I/O (collectively, the "Site"). By using our products and services, you are agreeing to these terms. Math I/O reserves the right to change, add, or remove portions of these terms of service at any time. </p>
    <h2>Description of Service</h2>
    <p> Math I/O provides a service to teachers and students to practice and reinforce math concepts through the use of educational games. </p>
    <h2>Accounts and Security </h2>
    <p>Math I/O allows you to open an account. You agree to provide true, accurate, current, and complete information about yourself when registering for an account. You agree to maintain and promptly update this information to keep it true, accurate, current, and complete. You are entirely responsible for maintaining the confidentiality of the information you hold for your account, including your password, and for any and all activity that occurs under your account as a result of your failing to keep this information secure and confidential. You agree to notify Math I/O immediately of any unauthorized use of your account or password, or any other breach of security. </p>
    <p>&nbsp;</p>
    </cms:editable>
    <!-- InstanceEndEditable -->
	</div>
